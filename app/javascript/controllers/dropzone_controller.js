...
export default class extends Controller {
  ...
  get uploadMultiple() {
    return this.data.get("uploadMultiple")
  }
  get form() {
...
class DirectUploadController {
  constructor(source, file) {
    this.directUpload = createDirectUpload(source, file)
    this.source = source
    this.file = file
  }
  ...
  bindProgressEvent(xhr) {
    this.xhr = xhr
    this.xhr.upload.addEventListener("progres", (event) => {
  ...
  emitDropzoneSuccess() {
    ...
    this.source.dropZone.emit("success", this.file, error)
    this.source.dropZone.emit("complete", this.file)
  }
}
